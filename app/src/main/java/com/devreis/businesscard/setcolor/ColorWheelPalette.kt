...
class ColorWheelPalette @JvmOverloads constructor(context: Context?, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        centerX = w * 0.5f
        centerY = h * 0.5f
        val hueShader: Shader =
            SweepGradient(centerX, centerY, intArrayOf(Color.RED, Color.MAGENTA, Color.BLUE, Color.CYAN, Color.GREEN, Color.YELLOW, Color.RED),
                null)
        huePaint.shader = hueShader
        val saturationShader: Shader = RadialGradient(centerX, centerY, radius,
