...
import com.devreis.businesscard.setcolor.Constants.SELECTOR_RADIUS_DP

class ColorWheelSelector @JvmOverloads constructor(context: Context?, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
